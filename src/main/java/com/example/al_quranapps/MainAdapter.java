...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.MainViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MainAdapter.MainViewHolder holder, int position) {
        ...
        holder.textViewTempatSurah.setText(chapters.getRevelationPlace());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("place", chapters.getRevelationPlace());
    ...
    public class MainViewHolder extends RecyclerView.ViewHolder {
        TextView textViewSurahLatin, textViewTerjemahanSurah, textViewSurahArab, textViewTempatSurah, textViewIdSurah;
        public MainViewHolder(@NonNull View itemView) {
            ...
            textViewTempatSurah = itemView.findViewById(R.id.tvViewTempatSurah);
